...
4. **To implement a requirement** (Phase 2+): read `.claude/skills/feature/SKILL.md` and include its full contents in the sub-agent's Task prompt along with the requirement ID and description.
5. **To review a completed feature**: read `.claude/skills/review/SKILL.md` and include its full contents in the sub-agent's Task prompt along with the requirement ID.
...
1. **Read `.claude/skills/feature/SKILL.md` and follow it step by step.**
...
1. **Read `.claude/skills/review/SKILL.md` and follow it step by step.**
